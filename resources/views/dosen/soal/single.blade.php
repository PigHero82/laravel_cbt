                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <h2 class="text-bold-700">CBTBIN17</h2>
                                            <p class="mb-0 line-ellipsis">Kode Soal</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <h2 class="text-bold-700">Bahasa Indonesia</h2>
                                            <p class="mb-0 line-ellipsis">Mata Kuliah</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" placeholder="Kode Soal">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <fieldset class="form-group mb-0">
                                                                            ...
                                                                            <img class="img-fluid mb-1" src="https://via.placeholder.com/500x300.png?text=Tidak+Ada+Data" alt="Placeholder">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <fieldset class="form-group">
                                                                <textarea class="form-control" rows="3" placeholder="Pertanyaan"></textarea>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                </div>
