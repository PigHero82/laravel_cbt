<div class="main-menu-content">
    <ul class="navigation navigation-main" {{ (request()->is('dosen*')) ? '' : 'hidden' }} id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item {{ (request()->is('dosen/paket*')) ? 'active' : '' }} {{ (request()->is('dosen/soal*')) ? 'active' : '' }}"><a href="{{ route('dosen.paket.index') }}"><i class="feather icon-file-text"></i><span class="menu-title">Soal</span></a></li>
        <li class="nav-item {{ (request()->is('laporan')) ? 'active' : '' }}"><a href="{{ route('dosen.laporan.index') }}"><i class="feather icon-printer"></i><span class="menu-title">Laporan</span></a></li>
    </ul>
