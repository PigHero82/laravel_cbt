                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <span><img src="{{ asset('logo.jpg') }}" alt="Logo" class="img-fluid mb-1" style="width: 100px; height: auto"></span>
                                            ...
                                            <div class="card-body pt-1">
                                                ...
                                                <form action="#">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="number" class="form-control" id="user-name" placeholder="NIDN/NIM" name="nidn" :value="old('nidn')" required autofocus />
                                                        <div class="form-control-position">
                                                            <i class="feather icon-user"></i>
                                                        </div>
                                                        <label for="user-name">NIDN/NIM</label>
                                                    </fieldset>
